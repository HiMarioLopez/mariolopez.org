...
export function Hero() {
  ...
  return (
    <div className="relative w-full flex flex-col items-center gap-0">
      <div
        className="relative w-full flex justify-center items-center h-[250px] md:h-[350px] min-h-[250px] md:min-h-[350px]"
      >
        <div
      ...
      <h1 className="text-5xl md:text-7xl font-bold tracking-tight font-mono text-start w-full mx-auto -mt-2 px-6 sm:px-0">
        Howdy hey, I'm Mario.
      </h1>
    </div>
  );
